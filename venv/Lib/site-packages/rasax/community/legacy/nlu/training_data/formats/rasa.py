...
from rasax.community.legacy.nlu.constants import TEXT, INTENT, ENTITIES
...
from rasax.community.legacy.utils.io import json_to_string
...
class RasaReader(JsonTrainingDataReader):
    def read_from_json(self, js: Dict[Text, Any], **_: Any) -> "TrainingData":
        ...
        import rasax.community.legacy.nlu.training_data.schemas.data_schema as schema
        import rasax.community.legacy.utils.validation as validation_utils
