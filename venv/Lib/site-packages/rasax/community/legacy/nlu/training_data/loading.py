...
from rasax.community.legacy.nlu.training_data.formats.dialogflow import (
    DIALOGFLOW_AGENT,
    DIALOGFLOW_ENTITIES,
...
def _reader_factory(fformat: Text) -> Optional["TrainingDataReader"]:
    ...
    from rasax.community.legacy.nlu.training_data.formats import (
        RasaYAMLReader,
        WitReader,
        LuisReader,
        RasaReader,
...
def guess_format(filename: Text) -> Text:
    ...
    try:
        content = rasax.community.legacy.utils.io.read_file(filename)
