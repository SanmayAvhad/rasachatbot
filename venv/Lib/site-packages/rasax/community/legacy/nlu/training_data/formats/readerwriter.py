...
class TrainingDataReader(abc.ABC):
    ...
    def read(self, filename: Union[Text, Path], **kwargs: Any) -> "TrainingData":
        ...
        return self.reads(rasax.community.legacy.utils.io.read_file(filename), **kwargs)
...
class TrainingDataWriter:
    ...
    def dump(self, filename: Text, training_data: "TrainingData") -> None:
        ...
        rasax.community.legacy.utils.io.write_text_file(s, filename)
    ...
    def prepare_training_examples(training_data: "TrainingData") -> OrderedDict:
        ...
        import rasax.community.legacy.nlu.training_data.util as rasa_nlu_training_data_utils
    ...
    def generate_list_item(text: Text) -> Text:
        ...
        return (
            f"- {rasax.community.legacy.nlu.training_data.util.encode_string(text)}\n"
        )
