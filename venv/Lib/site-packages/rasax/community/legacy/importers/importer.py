...
from rasax.community.legacy.core.events import ActionExecuted, UserUttered
from rasax.community.legacy.core.training_data.structures import StoryGraph
...
from rasax.community.legacy.nlu.constants import ENTITIES, ACTION_NAME
from rasax.community.legacy.importers.autoconfig import TrainingType
from rasax.community.legacy.core.domain import IS_RETRIEVAL_INTENT_KEY
...
class TrainingDataImporter:
    ...
    def load_from_config(
        ...
        config = rasax.community.legacy.utils.io.read_config_file(config_path)
    ...
    def load_from_dict(
        ...
        from rasax.community.legacy.importers.rasa import RasaFileImporter
    ...
    def _importer_from_dict(
        ...
        from rasax.community.legacy.importers.multi_project import MultiProjectImporter
        from rasax.community.legacy.importers.rasa import RasaFileImporter
        ...
        if module_path == RasaFileImporter.__name__:
            ...
            try:
                importer_class = rasax.community.legacy.utils.common.class_from_module_path(
                    module_path
                )
        ...
        constructor_arguments = rasax.community.legacy.utils.common.minimal_kwargs(
    ...
    def fingerprint(self) -> Text:
        ...
        return rasax.community.legacy.utils.io.random_string(25)
...
class CombinedDataImporter(TrainingDataImporter):
    ...
    @rasax.community.legacy.utils.common.cached_method
    def get_config(self) -> Dict:
        """Retrieves model config (see parent class for full docstring)."""
...
class ResponsesSyncImporter(TrainingDataImporter):
    ...
    def _construct_retrieval_action_names(retrieval_intents: Set[Text]) -> List[Text]:
        ...
        """
        return [
            f"{rasax.community.legacy.constants.UTTER_PREFIX}{intent}"
...
def _additional_training_data_from_default_actions() -> TrainingData:
    additional_messages_from_default_actions = [
        ...
        for action_name in rasax.community.legacy.core.constants.DEFAULT_ACTION_NAMES
    ]
