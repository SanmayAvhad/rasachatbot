...
def print_color(*args: Any, color: Text) -> None:
    output = rasax.community.legacy.utils.io.wrap_with_color(*args, color=color)
    try:
...
def print_success(*args: Any) -> None:
    print_color(*args, color=rasax.community.legacy.utils.io.bcolors.OKGREEN)


def print_info(*args: Any) -> None:
    print_color(*args, color=rasax.community.legacy.utils.io.bcolors.OKBLUE)


def print_warning(*args: Any) -> None:
    print_color(*args, color=rasax.community.legacy.utils.io.bcolors.WARNING)


def print_error(*args: Any) -> None:
    print_color(*args, color=rasax.community.legacy.utils.io.bcolors.FAIL)
