...
from rasax.community.legacy.core.constants import SHOULD_NOT_BE_SET
...
from rasax.community.legacy.core.trackers import DialogueStateTracker, FrozenState
...
from rasax.community.legacy.utils.io import is_logging_disabled
...
class TrackerWithCachedStates(DialogueStateTracker):
    ...
    def past_states_for_hashing(
        ...
        Args:
            domain: a :class:`rasax.community.legacy.core.domain.Domain`
    ...
    def _process_step(
        ...
        for event in events:
            if (
                ...
                rasax.community.legacy.utils.cli.print_warning(
