...
from rasax.community.legacy.constants import INTENT_MESSAGE_PREFIX
from rasax.community.legacy.core.constants import ACTION_LISTEN_NAME
from rasax.community.legacy.core.domain import Domain
from rasax.community.legacy.core.events import UserUttered, ActionExecuted, Event
from rasax.community.legacy.core.generator import TrainingDataGenerator
from rasax.community.legacy.core.training_data.structures import StoryGraph, StoryStep
...
def persist_graph(graph: "networkx.Graph", output_file: Text) -> None:
    ...
    template = rasax.community.legacy.utils.io.read_file(visualization_html_path())
    ...
    rasax.community.legacy.utils.io.write_text_file(template, output_file)
