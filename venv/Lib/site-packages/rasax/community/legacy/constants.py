...
MODEL_CONFIG_SCHEMA_FILE = "legacy/utils/schemas/model_config.yml"
CONFIG_SCHEMA_FILE = "legacy/utils/schemas/config.yml"
RESPONSES_SCHEMA_FILE = "legacy/nlu/training_data/schemas/responses.yml"
SCHEMA_EXTENSIONS_FILE = "legacy/utils/pykwalify_extensions.py"
LATEST_TRAINING_DATA_FORMAT_VERSION = "3.0"

DOMAIN_SCHEMA_FILE = "legacy/utils/schemas/domain.yml"
